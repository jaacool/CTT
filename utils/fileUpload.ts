...
/**
 * Forward attachments to another channel (reuse same files, no copy needed!)
 * @param attachments - Array of attachments to forward
 * @returns The same attachments array (no copy, just reference)
 */
export const forwardAttachments = (
  attachments: ChatAttachment[]
): ChatAttachment[] => {
  // Simply return the same attachments - they can be shared across channels!
  // No need to copy files, just reuse the same URLs
  // This saves storage space and is much faster
  return attachments;
};
