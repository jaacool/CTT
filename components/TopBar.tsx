...
export const TopBar: React.FC<TopBarProps> = ({ user, roles, canUndo, canRedo, onUndo, onRedo, onChangeRole }) => {
  ...
  return (
    <div className="w-full h-14 bg-c-surface border-b border-c-highlight flex items-center justify-between px-6">
      {/* User Info - Left Side */}
