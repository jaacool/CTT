                          ...
                          {editingMessageId === message.id ? (
                            ...
                            {((message.reactions && Object.keys(message.reactions).length > 0) || 
                              ...
                              <div className="flex flex-wrap gap-1 mt-1">
                                {/* Stern-Markierung */}
                                {message.starredBy && message.starredBy.includes(currentUser.id) && (
                                  <div className="flex items-center space-x-1 px-2 py-0.5 rounded-full bg-glow-purple/20 text-xs">
                                    <svg className="w-3 h-3 text-glow-purple" fill="currentColor" viewBox="0 0 24 24">
