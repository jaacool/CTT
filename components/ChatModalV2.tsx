                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex-1 relative">
                    <textarea
                      ...
                      className="w-full px-4 bg-overlay rounded-2xl text-sm focus:outline-none focus:ring-0 focus:border-transparent transition-all resize-none overflow-y-auto flex items-center caret-glow-purple"
                      rows={1}
                      style={{
                        height: '44px',
                        minHeight: '44px',
