        ...
        >
            ...
            <div className="flex items-center space-x-4 text-text-secondary">
                <button 
                    ...
                    className={`flex items-center space-x-2 px-2 py-1 rounded-md transition-all duration-300 cursor-pointer border border-transparent bg-gradient-to-r from-transparent to-transparent shadow-[inset_0_0_30px_10px_rgba(0,0,0,0),inset_0_0_20px_rgba(168,85,247,0),0_0_15px_-3px_rgba(168,85,247,0)] ${isActive ? 'glow-button text-text-primary' : 'hover:from-glow-cyan/10 hover:to-glow-magenta/10 hover:border-glow-cyan/10 hover:text-text-primary hover:shadow-[inset_0_0_30px_10px_rgba(0,0,0,0.5),inset_0_0_20px_rgba(168,85,247,0.15),0_0_15px_-3px_rgba(168,85,247,0.3)]'}`}
                >
                    {timerHovered ? (
                        isActive ? (
