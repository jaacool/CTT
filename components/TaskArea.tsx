        ...
        >
            ...
            <div className="flex items-center space-x-4 text-text-secondary">
                <button 
                    ...
                    className={`flex items-center space-x-2 px-2 py-1 rounded-md transition-all cursor-pointer ${isActive ? 'glow-button text-text-primary' : 'hover:bg-overlay/80 hover:text-glow-cyan hover:shadow-lg hover:shadow-glow-cyan/20'}`}
                >
                    {timerHovered ? (
                        isActive ? (
